...
def generate_readme(events, output_path):
    ...
    with open(output_path, 'w', encoding='utf-8') as out:
        ...
        out.write('```\n\n')
        out.write('**How it works:** Edit `events.json` → CI validates → Maintainer reviews → Merge → README auto-updates\n\n')
        
        out.write('## Community Standards\n\n')
        out.write('This project follows GitHub community best practices:\n\n')
        out.write('- 📖 [Contributing Guidelines](CONTRIBUTING.md) - Detailed contribution instructions\n')
        out.write('- 📋 [Code of Conduct](https://github.com/chethanyadav456/hyderabad-tech-events/blob/main/CONTRIBUTING.md#code-of-conduct) - Be respectful and inclusive\n')
        ...
        out.write('![GitHub issues](https://img.shields.io/github/issues/chethanyadav456/hyderabad-tech-events)\n')
        out.write('![GitHub pull requests](https://img.shields.io/github/issues-pr/chethanyadav456/hyderabad-tech-events)\n')
        out.write('![GitHub last commit](https://img.shields.io/github/last-commit/chethanyadav456/hyderabad-tech-events)\n')
        out.write('![GitHub](https://img.shields.io/github/license/chethanyadav456/hyderabad-tech-events)\n\n')
        
        out.write('## Maintainers\n\n')
        out.write('- [@chethanyadav456](https://github.com/chethanyadav456)\n\n')
        out.write('Questions? [Open an issue](../../issues) or check our [Contributing Guidelines](CONTRIBUTING.md).\n\n')
